...
Write-Host "----------------------------------------------------------------" -ForegroundColor Cyan
Write-Host "This script enables the Windows 11 NVMe Stack (Feature ID 416550087)."
Write-Host "This may improve storage performance on supported NVMe drives."
Write-Host ""
Write-Host "WARNING: This is an undocumented/hidden feature as of 12/21/2025." -ForegroundColor Yellow
Write-Host "         Use at your own risk as it may be unstable or change in future updates." -ForegroundColor Yellow
Write-Host ""
